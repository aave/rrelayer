...
| ----------- | --------------------------------------------------------------------------- |
| `400`       | Invalid transaction payload, unsupported transaction type, or failed simulation |
| `401`       | Authentication required or relayer permissions denied                       |
| `403`       | Relayer is paused                                                           |
| `404`       | Relayer does not exist                                                      |
| `409`       | `externalId` has already been used for this relayer with a different payload |
...
| `401`       | Authentication required or selected relayer API key invalid       |
| `409`       | `externalId` has already been used for the selected relayer with a different payload |
| `429`       | Transaction rate limit exceeded                                   |
